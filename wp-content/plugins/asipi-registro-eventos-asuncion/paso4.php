...
$textos = array(
    'es' => array(
        ...
        'msg_confirmacion' => 'Usted ya está registrado en el evento.  La información de acceso le será enviada en las semanas previas al evento.',
    ...
    'en' => array(
        ...
        'msg_confirmacion' => 'You are already registered in the event.  Login access will be sent a few days prior to the event.',
...
<div id="bloque-titulo">
    <div>
        <p><b><?php //echo $textos[$lang]['title'];
                ?></b></p>
    </div>
    <br>
    <?php if ($pago) { ?>
...
<div id="caja-registro" class="row" style="text-align: center;">
    ...
    <?php if ($pago) { ?>
    <div class="grid-1-2">
        <a href="/asipi-helper/dlReceiptEvento.php?&data=<?php echo $code ?>" class="btn btn-comprar btn-lg btn-block"
            id="btn_recibo" target="_blank">
    ...
    <?php } elseif($total > 0) { ?>
    <div class="grid-1-2">
        <a href="/asipi-helper/dlInvoiceEvento.php?&data=<?php echo $code ?>" class="btn btn-comprar btn-lg btn-block"
            id="btn_recibo" target="_blank">
            <?php echo __("<!--:es-->Ver Factura<!--:--><!--:en-->View Invoice<!--:-->") ?>
        </a>
    ...
    <div class="grid-1-2">
            ...
            <?php echo __("<!--:es-->Se ha editado su registro<!--:--><!--:en-->Your registration has been edited<!--:-->") ?>
